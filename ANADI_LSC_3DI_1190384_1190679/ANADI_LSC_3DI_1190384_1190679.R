...
#Como p-value>0.05, não rejeitamos H0, logo é possível afirmar que que não existem diferenças
...
#4 Conclusão:
#Em conclusão, este trabalho fornece uma análise estatística detalhada do conjunto de dados 
#usando ferramentas em R. Os resultados obtidos demonstram a eficiência do R na realização de 
#análises estatísticas complexas. Este trabalho também nos ensinou como usar efetivamente a 
#linguagem de programação R para explorar, manipular e analisar grandes conjuntos de dados. 
#A capacidade de adaptar a análise às necessidades específicas de uma reivindicação também é uma 
#vantagem importante do uso do R. No entanto, é importante salientar que é necessário conhecimento 
#estatístico suficiente para a correta interpretação dos resultados, o que reforça a importância 
#de um bom conhecimento teórico. Graças à perseverança e ao espírito cooperativo, conseguimos 
#superar esses obstáculos e dar continuidade a esse projeto. 
#Partilhar conhecimento e a ajuda mutua foram a chave para alcançar os nossos objetivos e concluir
#as tarefas com sucesso. Acreditamos que este processo colaborativo não 
#só melhora o produto final, mas também contribui para o desenvolvimento pessoal e profissional de
#cada membro.


#Referências Bibliográficas:
#https://moodle.isep.ipp.pt/pluginfile.php/277052/mod_resource/content/4/Estatistica%20Descritiva%20%28aula1%29.pdf
#https://moodle.isep.ipp.pt/pluginfile.php/277061/mod_resource/content/4/TestesParametricosPT.pdf
#https://moodle.isep.ipp.pt/pluginfile.php/277068/mod_resource/content/4/TestesNaoParametricosPT.pdf
#https://moodle.isep.ipp.pt/pluginfile.php/277082/mod_resource/content/6/ANADI-LEI-1718_RegressaoLinear.pdf
#https://moodle.isep.ipp.pt/pluginfile.php/277081/mod_resource/content/4/Testes_de_Correlacao.pdf
#https://www.infoescola.com/estatistica/teste-de-comparacao-de-medias-teste-de-tukey/
